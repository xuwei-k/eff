...
trait EvalInterpretation extends EvalTypes {
  ...
  def runEval[R, U, A](effect: Eff[R, A])(using m: Member.Aux[Eval, R, U]): Eff[U, A] =
  ...
  def attemptEval[R, U, A](effect: Eff[R, A])(using m: Member.Aux[Eval, R, U]): Eff[U, Throwable Either A] =
