...
"""
  ...
  def more = {
    Eff
      .send[Option1, Fx2[Option2, Option1], Int](Option1(1))
      .map(identity)
      .into[Fx2[Option1, Option2]]
      .runOpt
      .runOpt
      .run === 1

    Eff
      .send[Option1, Fx1[Option1], Int](Option1(1))
      .map(identity)
      .into[Fx3[Option1, Option2, Option3]]
      .runOpt
      .runOpt
      .runOpt
      .run === 1
    Eff
      .send[Option2, Fx1[Option2], Int](Option2(1))
      .map(identity)
      .into[Fx3[Option1, Option2, Option3]]
      .runOpt
      .runOpt
      ...
      .run === 1
    Eff
      .send[Option3, Fx1[Option3], Int](Option3(1))
      .map(identity)
      .into[Fx3[Option1, Option2, Option3]]
      .runOpt
      .runOpt
    ...
    Eff
      .send[Option1, Fx2[Option1, Option2], Int](Option1(1))
      .map(identity)
      .into[Fx3[Option1, Option2, Option3]]
      .runOpt
      .runOpt
