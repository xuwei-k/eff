...
"""
  ...
  def writerMember4: Member.Aux[WriterString, FxAppend[Fx3[WriterString, ReaderInt, Eval], NoFx], FxAppend[
    Fx2[ReaderInt, Eval],
    NoFx
  ]] =
    Member.MemberAppendL(writerMember3)

  def readerMember4: Member.Aux[ReaderInt, FxAppend[Fx3[WriterString, ReaderInt, Eval], NoFx], FxAppend[
    Fx2[WriterString, Eval],
    NoFx
  ]] =
