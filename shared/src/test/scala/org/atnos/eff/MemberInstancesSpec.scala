...
"""
  ...
  def memberAppendR = {
    ...
    Member
      .MemberAppendR[T5, Fx2[T1, T2], Fx3[T3, T4, T5], Fx2[T3, T4]](Member.Member3R[T3, T4, T5])
      .project(Union.appendR(Union.threeL(t3))) must beLeft(
      Union.appendR[Fx2[T1, T2], Fx2[T3, T4], Int](Union.twoL(t3))
    )
    Member
      .MemberAppendR[T5, Fx2[T1, T2], Fx3[T3, T4, T5], Fx2[T3, T4]](Member.Member3R[T3, T4, T5])
      .project(Union.appendR(Union.threeM(t4))) must beLeft(
      Union.appendR[Fx2[T1, T2], Fx2[T3, T4], Int](Union.twoR(t4))
    )
    Member
      .MemberAppendR[T5, Fx2[T1, T2], Fx3[T3, T4, T5], Fx2[T3, T4]](Member.Member3R[T3, T4, T5])
