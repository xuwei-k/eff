...
trait ValidateInterpretation extends ValidateCreation {
  ...
  def runValidatedNel[R, U, E, A](r: Eff[R, A])(implicit
    m: Member.Aux[Validate[E, *], R, U]
  ): Eff[U, ValidatedNel[E, A]] =
  ...
  def runMap[R, U, E, L: Semigroup, A](effect: Eff[R, A])(map: E => L)(implicit
    m: Member.Aux[Validate[E, *], R, U]
  ): Eff[U, L Either A] =
  ...
  def runIorMap[R, U, E, L: Semigroup, A](
    effect: Eff[R, A]
  )(map: E => L)(implicit m: Member.Aux[Validate[E, *], R, U]): Eff[U, L Ior A] =
  ...
  private def runMapGen[R, U, E, L: Semigroup, A, SomeOr[_, _]](
    ...
    map: E => L
  )(pure: (A, L Either Option[L]) => L SomeOr A)(implicit m: Member.Aux[Validate[E, *], R, U]): Eff[U, L SomeOr A] =
    runInterpreter(effect)(new Interpreter[Validate[E, *], U, A, L SomeOr A] {
      ...
      def onApplicativeEffect[X, T[_]: Traverse](
        xs: T[Validate[E, X]],
        continuation: Continuation[U, T[X], L SomeOr A]
      ): Eff[U, L SomeOr A] = {
  ...
  def catchWrongs[R, E, A, S[_]: Applicative](
    ...
    intercept(effect)(new Interpreter[Validate[E, *], R, A, A] {
      ...
      def onApplicativeEffect[X, T[_]: Traverse](
        xs: T[Validate[E, X]],
        continuation: Continuation[R, T[X], A]
      ): Eff[R, A] = {
  ...
  def catchFirstWrong[R, E, A](
    effect: Eff[R, A]
  )(handle: E => Eff[R, A])(implicit member: Validate[E, *] <= R): Eff[R, A] = {
  ...
  def catchAllWrongs[R, E, A](effect: Eff[R, A])(handle: NonEmptyList[E] => Eff[R, A])(implicit
    member: Validate[E, *] <= R
  ): Eff[R, A] =
