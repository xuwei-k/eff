 ...
 */
      def runAuth[R, U, A](
        e: Eff[R, A]
      )(implicit authenticated: Member.Aux[Authenticated, R, U], future: _future[U], either: _error[U]): Eff[U, A] =
...
${snippet {
      ...
      def runDb[R, U, A](queries: Eff[R, A])(implicit
        db: Member.Aux[Db, R, U],
        eval: _eval[U],
