...
// 8<---
  ...
  object HadoopStack {
    ...
    def runHadoopReader[R, U, A](conf: HadoopConf)(e: Eff[R, A])(using r: Member.Aux[HadoopReader, R, U]): Eff[U, A] =
  ...
  object S3Stack {
    ...
    def runS3Reader[R, U, A](conf: S3Conf)(e: Eff[R, A])(using r: Member.Aux[S3Reader, R, U]): Eff[U, A] =
      ReaderEffect.runReader(conf)(e)
  }
