...
trait either {
  ...
  def runDisjunctionCombine[R, U, E, A](r: Eff[R, A])(using m: Member.Aux[Either[E, *], R, U], s: Semigroup[E]): Eff[U, E \/ A] =
  ...
  def catchLeftCombine[R, E, A](r: Eff[R, A])(handle: E => Eff[R, A])(using member: Either[E, *] /= R, s: Semigroup[E]): Eff[R, A] =
